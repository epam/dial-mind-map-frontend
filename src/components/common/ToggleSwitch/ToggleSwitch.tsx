...
export function ToggleSwitch({ isOn, switchOnText, switchOFFText, handleSwitch }: ToggleSwitchProps) {
  ...
  return (
    <div data-qa="toggle-switch">
      <input type="checkbox" onChange={handleSwitch} id="toggle" className="sr-only" checked={isOn} />
