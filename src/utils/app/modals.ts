export function hasParentWithAttribute(element: Element | null, attributeName: string): boolean {
...
export const getPromptLimitDescription = (contentTokensLength: number, maxTokensLength: number) => {
